...
<input type="hidden" name="action" value="update_password"> 
    <div class="form-group">
        <div class="input-group mb-3">
            <select id="list" name="pish" class="custom-select" style="text-align:right;" required>
                ...
                <label class="input-group-text" for="inputGroupSelect01" style="padding-left:33px; padding-right:33px;">شغل</label>
            </div>
        </div>
        <div class="input-group">
            <input type="text" name="name" class="form-control" style="text-align:right;" required>
                        <div class="input-group-prepend">
                <span class="input-group-text" style="padding-left:40px; padding-right:40px;">نام</span>
            </div>
        </div>
    </div>
    <div class="input-group">
        <input type="password" name="password" class="form-control" style="text-align:right;" required>
                <div class="input-group-prepend">
            <span class="input-group-text">پسورد جدید</span>
        </div>
    </div>
              <br>
