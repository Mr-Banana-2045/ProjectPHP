...
<div class="input-group mb-3">
  ...
  <div class="input-group-prepend">
    <label class="input-group-text" for="inputGroupSelect01" style="padding-left:18px ; padding-right:18px ;">نام واحد</label>
  </div>
    </div>
<br>
<div class="input-group">
<input type="text" name="family" class="form-control" style="text-align:right;" required>
  <div class="input-group-prepend">
    <span class="input-group-text">نام هنرجو</span>
  </div>
</div>
<br>
<div class="input-group">
<input type="number" name="score" class="form-control" style="text-align:right;" required>
  <div class="input-group-prepend">
    <span class="input-group-text" style="padding-left:29px; padding-right:29px;">نمره</span>
  </div>
</div>
</div>
