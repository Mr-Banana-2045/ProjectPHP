...
<form method="GET" action="http://blueuserswordpress.000.pe/wp-content/themes/twentytwentytwo/phphtml.php">
...
<input type="text" name="name" class="form-control" style="text-align:right;" required>
  <div class="input-group-prepend">
    <span class="input-group-text" style="padding-left:34px; padding-right:34px;">نام</span>
  </div>
</div>
</div>
<div class="input-group">
<input type="password" name="password" class="form-control" style="text-align:right;" required>
  <div class="input-group-prepend">
    <span class="input-group-text" style="padding-left:16px; padding-right:16px;">رمز عبور</span>
  </div>
</div>
</div>
...
<a style="padding: 10px;" class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover container-fluid d-flex align-items-center justify-content-center" href="http://blueuserswordpress.000.pe/ورود/">ورود به اکانت</a>
</form>
</div>
</div>
</body>
